...
function forSaleFunc() {
  ...
  fetch(`https://realty-in-us.p.rapidapi.com/properties/list-for-sale?state_code=${usState}&city=${usCity}&offset=0&limit=${limit}&sort=${sortBy.value}&beds_min=${document.getElementById('minBeds').value}`, options)
